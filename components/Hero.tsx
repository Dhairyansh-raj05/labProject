  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-slate-900 min-h-[400px] lg:aspect-[21/9] flex items-center group">
      ...
      <div className="relative z-10 px-8 lg:px-20 max-w-4xl py-12 lg:py-0 flex flex-col gap-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 border border-primary/30 text-primary text-xs font-bold uppercase tracking-widest w-fit text-[#b40df1] bg-[#33113e] bg-opacity-20 border-[#b90df2] border-opacity-30">
          <BadgeCheck className="w-4 h-4 text-[#b40df1]" /> Verified Secondhand
          Gamming Devices
        </div>
        <h1 className="text-white text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight">
          Battle-Tested <span className="text-[#b90df2]">Gear</span>
        </h1>
        <p className="text-slate-300 text-lg lg:text-xl leading-relaxed max-w-xl">
          Level up sustainably. Premium Secondhand consoles and games, inspected
