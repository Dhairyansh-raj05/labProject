    ...
    <section className="bg-primary/5 rounded-2xl p-8 lg:p-12 border border-primary/20">
      <div className="flex flex-col gap-10">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-black tracking-tight mb-4 text-white">Why Trust ReGeno?</h2>
          <p className="text-slate-400">We ensure every piece of gear is ready for its next adventure with our industry-leading restoration process, now serving the Indian gaming community.</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div key={i} className="flex flex-col items-center text-center gap-4 p-8 bg-[#1a1a1a] rounded-xl border border-white/10 hover:border-primary/50 transition-colors group">
